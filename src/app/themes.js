...
export const THEMES = {
  dark: {
    ...
    tokens: {
      ...
      accent: "#6EE7D8", ready: "#7EE787", repair: "#FF6B6B", none: "#F2B84B",
  ...
  light: {
    ...
    tokens: {
      ...
      accent: "#A15C25", ready: "#4F7A3D", repair: "#B33F2C", none: "#3E6B99",
  ...
  nord: {
    ...
    tokens: {
      ...
      accent: "#88C0D0", ready: "#A3BE8C", repair: "#BF616A", none: "#EBCB8B",
